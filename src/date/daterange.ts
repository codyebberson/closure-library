...
goog.date.DateRange.prototype.contains = function (date) {
  return date.valueOf() >= this.startDate_.valueOf() && date.valueOf() <= this.endDate_.valueOf();
};
 ...
 */
goog.date.DateRange.equals = (a, b) => {
 ...
 * @private
 */
goog.date.DateRange.offsetInDays_ = (date, offset) => {
 ...
 * @private
 */
goog.date.DateRange.offsetInMonths_ = (date, offset) => {
  var newDate = date.clone();
  newDate.setDate(1);
 ...
 */
goog.date.DateRange.yesterday = (opt_today) => {
 ...
 */
goog.date.DateRange.today = (opt_today) => {
  var today = goog.date.DateRange.cloneOrCreate_(opt_today);
 ...
 *     end yesterday.
 */
goog.date.DateRange.last7Days = (opt_today) => {
  var today = goog.date.DateRange.cloneOrCreate_(opt_today);
  var yesterday = goog.date.DateRange.offsetInDays_(today, -1);
 ...
 */
goog.date.DateRange.thisMonth = (opt_today) => {
  var today = goog.date.DateRange.cloneOrCreate_(opt_today);
  return new goog.date.DateRange(
    goog.date.DateRange.offsetInMonths_(today, 0),
    goog.date.DateRange.offsetInDays_(goog.date.DateRange.offsetInMonths_(today, 1), -1)
  );
};
 ...
 */
goog.date.DateRange.lastMonth = (opt_today) => {
  var today = goog.date.DateRange.cloneOrCreate_(opt_today);
  return new goog.date.DateRange(
    goog.date.DateRange.offsetInMonths_(today, -1),
    goog.date.DateRange.offsetInDays_(goog.date.DateRange.offsetInMonths_(today, 0), -1)
  );
};
 ...
 */
goog.date.DateRange.thisWeek = (opt_today) => {
  var today = goog.date.DateRange.cloneOrCreate_(opt_today);
 ...
 */
goog.date.DateRange.lastWeek = (opt_today) => {
 ...
 */
goog.date.DateRange.lastBusinessWeek = (opt_today) => {
 ...
 */
goog.date.DateRange.allTime = (opt_today) =>
  new goog.date.DateRange(goog.date.DateRange.MINIMUM_DATE, goog.date.DateRange.MAXIMUM_DATE);
 ...
 */
goog.date.DateRange.standardDateRange = (dateRangeKey, opt_today) => {
  switch (dateRangeKey) {
 ...
 * @private
 */
goog.date.DateRange.cloneOrCreate_ = (opt_today) =>
  opt_today ? opt_today.clone() : new goog.date.Date();
