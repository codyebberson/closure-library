...
/** @override */
goog.math.interpolator.Pchip1.prototype.computeDerivatives = function (dx, slope) {
  const len = dx.length;
  ...
  deriv[0] = this.computeDerivativeAtBoundary_(dx[0], dx[1], slope[0], slope[1]);
 ...
 * @private
 */
goog.math.interpolator.Pchip1.prototype.computeDerivativeAtBoundary_ = (
  dx0,
  dx1,
  slope0,
  slope1
