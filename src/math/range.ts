 ...
 */
goog.math.Range.intersection = (a, b) => {
 ...
 */
goog.math.Range.hasIntersection = (a, b) => Math.max(a.start, b.start) <= Math.min(a.end, b.end);
 ...
 *     range.
 */
goog.math.Range.boundingRange = (a, b) =>
  new goog.math.Range(Math.min(a.start, b.start), Math.max(a.end, b.end));
 ...
 */
goog.math.Range.contains = (a, b) => a.start <= b.start && a.end >= b.end;
 ...
 */
goog.math.Range.containsPoint = (range, p) => range.start <= p && range.end >= p;
