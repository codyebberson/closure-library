 ...
 */
goog.math.Coordinate3.distance = (a, b) => {
  const dx = a.x - b.x;
  const dy = a.y - b.y;
  const dz = a.z - b.z;
 ...
 */
goog.math.Coordinate3.squaredDistance = (a, b) => {
  const dx = a.x - b.x;
  const dy = a.y - b.y;
  const dz = a.z - b.z;
...
goog.math.Coordinate3.difference = (a, b) =>
  new goog.math.Coordinate3(a.x - b.x, a.y - b.y, a.z - b.z);
 ...
 */
goog.math.Coordinate3.fromArray = (a) => {
  if (a.length <= 3) {
