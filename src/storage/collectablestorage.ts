 ...
 * @private
 */
goog.storage.CollectableStorage.prototype.getExpiredKeys_ = function (keys, opt_strict) {
  const keysToRemove = [];
  goog.iter.forEach(
    keys,
    function (key) {
      ...
      try {
        wrapper = goog.storage.CollectableStorage.prototype.getWrapper.call(this, key, true);
      } catch (ex) {
 ...
 * @protected
 */
goog.storage.CollectableStorage.prototype.collectInternal = function (keys, opt_strict) {
