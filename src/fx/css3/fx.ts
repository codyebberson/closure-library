 ...
 */
goog.fx.css3.fade = (element, duration, timing, startOpacity, endOpacity) =>
  new goog.fx.css3.Transition(
    element,
    duration,
 ...
 * @return {!goog.fx.css3.Transition} The transition object.
 */
goog.fx.css3.fadeIn = (element, duration) => goog.fx.css3.fade(element, duration, 'ease-out', 0, 1);
 ...
 * @return {!goog.fx.css3.Transition} The transition object.
 */
goog.fx.css3.fadeOut = (element, duration) => goog.fx.css3.fade(element, duration, 'ease-in', 1, 0);
