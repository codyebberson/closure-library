...
testSuite({
  ...
  testComputeValue() {
    assertEquals('50% of 100 is 50', 50, coordinates.computeValue('50%', 100, null));
    assertEquals('50.5% of 200 is 101', 101, coordinates.computeValue('50.5%', 200, null));
    assertEquals('50px = 25 units when in 2x view', 25, coordinates.computeValue('50px', null, 2));
  },
  ...
  testGenericGetValue() {
    ...
    assertEquals('Testing cache usage', 'OVERWRITE', getValue('50%', false, 100, 2, cache));
