 ...
 */
goog.userAgent.keyboard.ASSUME_MAC_KEYBOARD = goog.define(
...
goog.userAgent.keyboard.determineMacKeyboard_ = () =>
  goog.labs.userAgent.platform.isMacintosh() || goog.labs.userAgent.platform.isIos();
...
goog.userAgent.keyboard.MAC_KEYBOARD =
  goog.userAgent.keyboard.ASSUME_MAC_KEYBOARD || goog.userAgent.keyboard.determineMacKeyboard_();
