...
let documentMode;
/** @suppress {visibility} */
userAgent.getDocumentMode_ = () => documentMode;
...
testSuite({
  ...
  testOperaInit() {
    ...
    propertyReplacer.set(goog, 'global', mockGlobal);
    propertyReplacer.set(userAgent, 'getUserAgentString', () => testAgents.OPERA_MINI);
    ...
    propertyReplacer.set(goog, 'global', mockGlobal);
    propertyReplacer.set(userAgent, 'getUserAgentString', () => testAgents.OPERA_15);
  ...
  testCompare() {
    ...
    assertTrue('mutlidot equality broken', userAgent.compare('1.0.0.0', '1.0') == 0);
  ...
  testGecko() {
    assertGecko(
      'Mozilla/5.0 (Windows; U; Windows NT 5.1; nl-NL; rv:1.7.5)' + 'Gecko/20041202 Gecko/1.0',
      '1.7.5'
    );
    assertGecko(
      'Mozilla/5.0 (X11; U; Linux x86_64; en-US; rv:1.7.6)' + 'Gecko/20050512 Gecko',
      '1.7.6'
    );
    assertGecko(
      'Mozilla/5.0 (X11; U; FreeBSD i386; en-US; rv:1.7.8)' + 'Gecko/20050609 Gecko/1.0.4',
      '1.7.8'
    );
    assertGecko(
      'Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.7.9)' + 'Gecko/20050711 Gecko/1.0.5',
      '1.7.9'
    );
    assertGecko(
      'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7.10)' + 'Gecko/20050716 Gecko/1.0.6',
      '1.7.10'
    );
    assertGecko(
    ...
    assertGecko(
      'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7.12)' + 'Gecko/20050915 Gecko/1.0.7',
      '1.7.12'
    );
    assertGecko(
    ...
    assertGecko(
      'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.8b4)' + 'Gecko/20050908 Gecko/1.4',
      '1.8b4'
    );
    assertGecko(
      'Mozilla/5.0 (Windows; U; Windows NT 5.1; nl; rv:1.8)' + 'Gecko/20051107 Gecko/1.5',
      '1.8'
    );
    assertGecko(
    ...
    assertGecko(
      'Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.8.0.2)' + 'Gecko/20060308 Gecko/1.5.0.2',
      '1.8.0.2'
    );
    assertGecko(
      'Mozilla/5.0 (Macintosh; U; PPC Mac OS X Mach-O; en-US;' +
    ...
    assertGecko(
      'Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.8.0.3)' + 'Gecko/20060426 Gecko/1.5.0.3',
      '1.8.0.3'
    );
    assertGecko(
      'Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.8.0.4)' + 'Gecko/20060508 Gecko/1.5.0.4',
      '1.8.0.4'
    );
    assertGecko(
    ...
    assertGecko(
      'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.8)' + 'Gecko/20060321 Gecko/2.0a1',
      '1.8'
    );
    assertGecko('Mozilla/5.0 (X11; Linux i686; rv:6.0) Gecko/6.0 Firefox/6.0', '6.0');
  },
  ...
  testIe() {
    ...
    assertIe('Mozilla/5.0 (Windows NT 6.3; Trident/7.0; rv:11.0) like Gecko', '11.0');
  },

  testIeDocumentModeOverride() {
    documentMode = 9;
    assertIe('Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.1; Trident/5.0', '9');
    assertIe('Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; Trident/5.0', '9');

    documentMode = 8;
    assertIe('Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; Trident/5.0', '8.0');
  },

  testDocumentModeInStandardsMode() {
    userAgentTestUtil.reinitializeUserAgent();
    const expectedMode = userAgent.IE ? Number.parseInt(userAgent.VERSION, 10) : undefined;
