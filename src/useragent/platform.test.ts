...
testSuite({
  ...
  testWindows() {
    ...
    const win98 = 'Mozilla/4.0 (compatible; MSIE 6.0b; Windows 98; Win 9x 4.90)';
    ...
    const win81 = 'Mozilla/5.0 (Windows NT 6.3; Trident/7.0; rv:11.0) like Gecko';
  ...
  testAndroidBrowser() {
    const uaString =
      'Mozilla/5.0 (Linux; U; Android 2.3.4; fr-fr;' +
  ...
  testIPod22() {
    ...
    const uaString =
      'Mozilla/5.0 (iPod; U; CPU iPhone OS 2_2 like ' +
  ...
  testIPod91() {
    // Borrowing from webserver/browser_rules for user agents
    const uaString =
      'Mozilla/5.0 (iPod; CPU iPhone OS 9_1 like ' +
