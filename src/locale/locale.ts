 ...
 */
goog.locale.getLanguageSubTag = (languageCode) => {
 ...
 */
goog.locale.getRegionSubTag = (languageCode) => {
 ...
 */
goog.locale.getScriptSubTag = (languageCode) => {
 ...
 */
goog.locale.getVariantSubTag = (languageCode) => {
 ...
 */
goog.locale.getNativeCountryName = (countryCode) => {
  var key =
    goog.locale.getLanguageSubTag(countryCode) + '_' + goog.locale.getRegionSubTag(countryCode);
 ...
 */
goog.locale.getLocalizedCountryName = (languageCode, opt_localeSymbols) => {
  var code = goog.locale.getRegionSubTag(languageCode);
  var name = goog.locale.getLocalizedRegionNameFromRegionCode(code, opt_localeSymbols);
 ...
 */
goog.locale.getLocalizedRegionNameFromRegionCode = (regionCode, opt_localeSymbols) => {
 ...
 */
goog.locale.getNativeLanguageName = (languageCode) => {
 ...
 */
goog.locale.getLocalizedLanguageName = (languageCode, opt_localeSymbols) => {
  if (!opt_localeSymbols) {
    opt_localeSymbols = goog.locale.getResource('LocaleNameConstants', goog.locale.getLocale());
  }
 ...
 */
goog.locale.registerResource = (dataObj, resourceName, localeName) => {
 ...
 */
goog.locale.isResourceRegistered = (resourceName, localeName) =>
  resourceName in goog.locale.resourceRegistry_ &&
 ...
 */
goog.locale.registerTimeZoneConstants = (dataObj, localeName) => {
 ...
 * @param {string} localeName Locale ID.
 */
goog.locale.registerLocaleNameConstants = (dataObj, localeName) => {
 ...
 * @param {string} localeName Locale ID.
 */
goog.locale.registerTimeZoneSelectedIds = (dataObj, localeName) => {
 ...
 * @param {string} localeName Locale ID.
 */
goog.locale.registerTimeZoneSelectedShortNames = (dataObj, localeName) => {
 ...
 * @param {string} localeName Locale ID.
 */
goog.locale.registerTimeZoneSelectedLongNames = (dataObj, localeName) => {
  goog.locale.registerResource(
    dataObj,
 ...
 * @param {string} localeName Locale ID.
 */
goog.locale.registerTimeZoneAllLongNames = (dataObj, localeName) => {
 ...
 */
goog.locale.getResource = (resourceName, opt_locale) => {
 ...
 */
goog.locale.getResourceWithFallback = (resourceName, opt_locale) => {
  var locale = opt_locale ? opt_locale : goog.locale.getLocale();
