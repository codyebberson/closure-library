 ...
 * @private
 */
goog.tweak.Registry.prototype.logger_ = goog.log.getLogger('goog.tweak.Registry');
 ...
 */
goog.tweak.Registry.parseQueryParams = (queryParams) => {
...
goog.tweak.Registry.prototype.makeUrlQuery = function (opt_existingSearchStr) {
  var existingParams =
    opt_existingSearchStr == undefined ? window.location.search : opt_existingSearchStr;
  ...
  sortedEntries.sort((a, b) => goog.array.defaultCompare(a.getParamName(), b.getParamName()));
