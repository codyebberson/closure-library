 ...
 */
goog.module.Loader.require = (module, symbol, callback) => {
 ...
 */
goog.module.Loader.provide = (module, opt_symbol, opt_object) => {
 ...
 *     load.
 */
goog.module.Loader.init = (urlBase, opt_urlFunction) => {
 ...
 */
goog.module.Loader.loaderCall = (module, symbol) => () => {
  var args = arguments;
  goog.module.Loader.require(module, symbol, (f) => {
    f.apply(null, args);
  });
};
 ...
 * @private
 */
goog.module.Loader.prototype.getModuleUrl_ = (urlBase, module) => urlBase + '_' + module + '.js';
...
goog.module.Loader.prototype.load_ = function (module) {
  ...
  goog.Timer.callOnce(
    function () {
      ...
      var s = goog.dom.createDom(goog.dom.TagName.SCRIPT, { type: 'text/javascript' });
      goog.dom.safe.setScriptSrc(s, goog.html.legacyconversions.trustedResourceUrlFromString(url));
