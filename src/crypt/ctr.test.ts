 ...
 */
function runCtrAesTest(keyBytes, initialVectorBytes, plainTextBytes, cipherTextBytes) {
...
testSuite({
  ...
  testAes128CtrCipherAlgorithm() {
    ...
    runCtrAesTest(
      ...
      googCrypt.hexToByteArray('f0f1f2f3f4f5f6f7f8f9fafbfcfdfeff'),
      googCrypt.hexToByteArray(
        '6bc1bee22e409f96e93d7e117393172a' + 'ae2d8a571e03ac9c9eb76fac45af8e51' + '30c81c'
      ),
      googCrypt.hexToByteArray(
        '874d6191b620e3261bef6864990db6ce' + '9806f66b7970fdff8617187bb9fffdff' + '5ae4df'
      )
    );
  },
  ...
  testAes192CtrCipherAlgorithm() {
    ...
    // Case #1, no chaining
    runCtrAesTest(
      googCrypt.hexToByteArray('8e73b0f7da0e6452c810f32b809079e5' + '62f8ead2522c6b7b'),
      googCrypt.hexToByteArray('f0f1f2f3f4f5f6f7f8f9fafbfcfdfeff'),
      googCrypt.hexToByteArray('6bc1bee22e409f96e93d7e117393172a'),
