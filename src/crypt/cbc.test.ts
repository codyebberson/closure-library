...
function runCbcAesTest(keyBytes, initialVectorBytes, plainTextBytes, cipherTextBytes) {
...
testSuite({
  testAesCbcCipherAlgorithm() {
    ...
    runCbcAesTest(
      ...
      crypt.hexToByteArray('000102030405060708090a0b0c0d0e0f' + '101112131415161718191a1b1c1d1e1f'),
      crypt.hexToByteArray('d296cd94c2cccf8a3a863028b5e1dc0a' + '7586602d253cfff91b8266bea6d61ab1')
    );
