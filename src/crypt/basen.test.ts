...
function verifyConversion(inputBase, inputNumber, outputBase, outputNumber) {
  assertEquals(outputNumber, baseN.recodeString(inputNumber, inputBase, outputBase));
}
testSuite({
  testDecToHex() {
    verifyConversion(baseN.BASE_DECIMAL, '0', baseN.BASE_LOWERCASE_HEXADECIMAL, '0');
    verifyConversion(baseN.BASE_DECIMAL, '9', baseN.BASE_UPPERCASE_HEXADECIMAL, '9');
    verifyConversion(baseN.BASE_DECIMAL, '13', baseN.BASE_LOWERCASE_HEXADECIMAL, 'd');
    verifyConversion(baseN.BASE_DECIMAL, '255', baseN.BASE_UPPERCASE_HEXADECIMAL, 'FF');
    verifyConversion(
      baseN.BASE_DECIMAL,
      '53425987345897',
      baseN.BASE_LOWERCASE_HEXADECIMAL,
      '309734ff5de9'
    );
    verifyConversion(baseN.BASE_DECIMAL, '987080888', baseN.BASE_UPPERCASE_HEXADECIMAL, '3AD5A8B8');
    verifyConversion(
      baseN.BASE_DECIMAL,
      '009341587237',
      baseN.BASE_LOWERCASE_HEXADECIMAL,
  ...
  testZeros() {
    verifyConversion(baseN.BASE_DECIMAL, '0', baseN.BASE_LOWERCASE_HEXADECIMAL, '0');
    verifyConversion(baseN.BASE_DECIMAL, '000', baseN.BASE_LOWERCASE_HEXADECIMAL, '0');
    verifyConversion(baseN.BASE_DECIMAL, '0000007', baseN.BASE_LOWERCASE_HEXADECIMAL, '7');
  },
  ...
  testEmptyBases() {
    ...
    assertEquals(
      'Exception message',
      'Number 1230 contains a character ' + 'not found in base , which is 0',
      e.message
    );
  ...
  testInvalidDigits() {
    ...
    assertEquals(
      'Exception message',
      'Number 123x456 contains a character ' + 'not found in base 01234567, which is x',
      e.message
    );
  },

  testHugeInputBase() {
    verifyConversion(makeHugeBase(), String.fromCharCode(12345), baseN.BASE_DECIMAL, '12345');
  },

  testHugeOutputBase() {
    verifyConversion(baseN.BASE_DECIMAL, '12345', makeHugeBase(), String.fromCharCode(12345));
  },
});
