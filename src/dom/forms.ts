...
goog.dom.forms.submitFormDataInNewWindow = (actionUri, method, formData) => {
  ...
  formData.forEach((fieldValues, fieldName) => {
 ...
 * @private
 */
goog.dom.forms.getFormDataHelper_ = (form, result, fnAppend) => {
 ...
 * @private
 */
goog.dom.forms.addFormDataToMap_ = (map, name, value) => {
 ...
 * @private
 */
goog.dom.forms.addFormDataToStringBuffer_ = (sb, name, value) => {
 ...
 * @return {boolean} Whether the form has a value.
 */
goog.dom.forms.hasValueByName = (form, name) => {
 ...
 * @private
 */
goog.dom.forms.getInputChecked_ = (el) => (el.checked ? /** @type {?} */ (el).value : null);
 ...
 * @private
 */
goog.dom.forms.getSelectSingle_ = (el) => {
 ...
 * @private
 */
goog.dom.forms.getSelectMultiple_ = (el) => {
  var values = [];
