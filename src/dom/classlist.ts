 ...
 * @private
 */
goog.dom.classlist.getClassName_ = (element) => {
...
goog.dom.classlist.add = (element, className) => {
  ...
  if (!goog.dom.classlist.contains(element, className)) {
    ...
    goog.dom.classlist.set(
      element,
      oldClassName + (oldClassName.length > 0 ? ' ' + className : className)
    );
  }
};
...
goog.dom.classlist.addAll = (element, classesToAdd) => {
  if (goog.dom.classlist.ALWAYS_USE_DOM_TOKEN_LIST || element.classList) {
    Array.prototype.forEach.call(classesToAdd, (className) => {
      goog.dom.classlist.add(element, className);
    });
    return;
  }
  ...
  Array.prototype.forEach.call(goog.dom.classlist.get(element), (className) => {
...
goog.dom.classlist.remove = (element, className) => {
  ...
  if (goog.dom.classlist.contains(element, className)) {
    ...
    goog.dom.classlist.set(
      element,
      Array.prototype.filter.call(goog.dom.classlist.get(element), (c) => c != className).join(' ')
    );
  }
};
...
goog.dom.classlist.removeAll = (element, classesToRemove) => {
  if (goog.dom.classlist.ALWAYS_USE_DOM_TOKEN_LIST || element.classList) {
    Array.prototype.forEach.call(classesToRemove, (className) => {
      goog.dom.classlist.remove(element, className);
    });
    return;
  }
  ...
  goog.dom.classlist.set(
    ...
    Array.prototype.filter
      .call(goog.dom.classlist.get(element), (className) => {
