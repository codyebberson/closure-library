...
const BASE_VECTORS = [
  ...
  {
    input: 'ftp://username:password@example.com',
    expected: 'ftp://username:password@example.com',
    safe: true,
  },
  { input: 'HTtp://example.com/', expected: 'HTtp://example.com/', safe: true },
  {
    input: 'https://example.com/path?foo\u003Dbar#baz',
    expected: 'https://example.com/path?foo\u003Dbar#baz',
    safe: true,
  },
  {
    input: 'https://example.com:123/path?foo\u003Dbar\u0026abc\u003Ddef#baz',
    expected: 'https://example.com:123/path?foo\u003Dbar\u0026abc\u003Ddef#baz',
    safe: true,
  },
  ...
  {
    input: 'itms-services://?action\u003Ddownload-manifest\u0026url\u003Dfoo',
    expected: 'about:invalid#zClosurez',
    safe: false,
  },
  ...
  },
  {
    ...
    expected: 'data:image/webp;base64,abc\u003D\u003D\u003D',
    safe: true,
  },
  ...
  {
    input: 'data:audio/x-matroska;base64,z\u003D',
    expected: 'data:audio/x-matroska;base64,z\u003D',
    safe: true,
  },
  ...
  {
    input: 'data:video/webm;base64,z\u003D',
    expected: 'data:video/webm;base64,z\u003D',
    safe: true,
  },
  {
    input: 'data:video/x-matroska;base64,z\u003D',
    expected: 'data:video/x-matroska;base64,z\u003D',
    safe: true,
  },
  {
    input: 'data:video/quicktime;base64,z\u003D',
    expected: 'data:video/quicktime;base64,z\u003D',
    safe: true,
  },
  {
    input: 'data:video/webm;foo\u003Dbar;base64,z\u003D',
    expected: 'data:video/webm;foo\u003Dbar;base64,z\u003D',
    safe: true,
  },
  {
    input: 'data:video/webm;foo\u003D"bar";base64,z\u003D',
  ...
  {
    input: 'data:video/webm;codecs\u003D"vp8,opus";base64,z\u003D',
    expected: 'data:video/webm;codecs\u003D"vp8,opus";base64,z\u003D',
    safe: true,
  },
  {
    input: 'data:video/webm;codecs\u003D"vp8, opus";base64,z\u003D',
