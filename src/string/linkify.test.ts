...
function assertLinkify(
  ...
  assertEquals(
    ...
    expected,
    SafeHtml.unwrap(
      linkify.linkifyPlainTextAsHtml(input, {
...
testSuite({
  ...
  testEndsWithALink() {
    assertLinkify(
      ...
      'Look at this search engine: ' + '<a href="http://www.google.com/">http://www.google.com/</a>'
    );
  },
  ...
  testSingleQuoteInUrl() {
    assertLinkify(
      "URLs containing ' include quote in link",
      "http://google.com/yo'yo",
  ...
  testUrlHashBang() {
    assertLinkify(
      'URL with #!',
      'Another test URL: ' + 'https://www.google.com/testurls/#!/page',
      'Another test URL: ' +
  ...
  testJsInjection() {
    assertLinkify(
      ...
      googString.htmlEscape("Welcome in hell <script>alert('this is hell')</script>")
    );
  },
  ...
  testJsInjectionWithIgnorableNonTagChar() {
    assertLinkify(
      'Angle brackets are normalized even when followed by an ignorable ' + 'non-tag character.',
  ...
  testLinkifyNoOptions() {
    safe.setInnerHtml(div, linkify.linkifyPlainTextAsHtml('http://www.google.com'));
  ...
  testLinkifyOptionsClassName() {
    safe.setInnerHtml(
      div,
      linkify.linkifyPlainTextAsHtml('Attribute with <class> name www.w3c.org.', {
  ...
  testFindFirstUrlNoSchemeWithText() {
    assertEquals('www.google.com', linkify.findFirstUrl('prefix www.google.com something'));
  },

  testFindFirstUrlScheme() {
    assertEquals('http://www.google.com', linkify.findFirstUrl('http://www.google.com'));
  },
  ...
  testFindFirstUrlNoUrl() {
    assertEquals('', linkify.findFirstUrl('ygvtfr676 5v68fk uygbt85F^&%^&I%FVvc .'));
  },
  ...
  testFindFirstEmailNoSchemeWithText() {
    assertEquals('fake@google.com', linkify.findFirstEmail('prefix fake@google.com something'));
  },

  testFindFirstEmailScheme() {
    assertEquals('mailto:fake@google.com', linkify.findFirstEmail('mailto:fake@google.com'));
  },
  ...
  testFindFirstEmailNoEmail() {
    assertEquals('', linkify.findFirstEmail('ygvtfr676 5v68fk uygbt85F^&%^&I%FVvc .'));
  },
  ...
  testContainsPunctuation_parens() {
    assertLinkify(
      ...
      '<a href="http://www.google.com/abc(v1).html">' + 'www.google.com/abc(v1).html</a>'
    );
  },
  ...
  testEndsWithPunctuation_curlies() {
    ...
    assertLinkify(
      'Curly brackets inside link',
      'http://www.google.com/abc{arg=1}',
      '<a href="http://www.google.com/abc{arg=1}">' + 'http://www.google.com/abc{arg=1}</a>'
    );
  },
  ...
  testEndsWithPunctuation_ellipses() {
    assertLinkify(
      ...
      'just look it up on <a href="http://www.google.com">www.google.com' + '</a>...'
    );
  },
  ...
  testUsuallyUnrecognizedCharactersAreNotInUrl() {
    assertLinkify(
      ...
      '<a href="https://www.google.com/?q=">' + 'https://www.google.com/?q=</a>&lt;^&gt;&quot;'
    );
  },
  ...
  testPreserveSpacesAndTabs() {
    ...
    assertLinkify(
      'Preserving spaces with no links',
      ' Line 1\n  Line 2 ',
      '&#160;Line 1\n&#160; Line 2 ',
      /* preserveNewlines */ false,
      /* preserveSpacesAndTabs */ true
