...
goog.format.JsonPrettyPrinter = function (opt_delimiters) {
   ...
   */
  this.delimiters_ = opt_delimiters || new goog.format.JsonPrettyPrinter.TextDelimiters();
...
goog.format.JsonPrettyPrinter.prototype.printObject_ = function (val, outputBuffer, indent) {
  ...
  switch (typeOf) {
    ...
    case 'string':
      ...
      this.printValue_(/** @type {null|string|boolean|number} */ (val), typeOf, outputBuffer);
      break;
    case 'array':
    ...
    case 'object':
      ...
      for (var name in val) {
        ...
        outputBuffer.push(this.delimiters_.nameValueSeparator, this.delimiters_.space);
...
goog.format.JsonPrettyPrinter.prototype.printName_ = function (name, outputBuffer) {
  outputBuffer.push(this.delimiters_.formatName(this.jsonSerializer_.serialize(name)));
};
 ...
 */
goog.format.JsonPrettyPrinter.TextDelimiters.prototype.formatName = function (name) {
 ...
 * @return {string|!goog.html.SafeHtml}
 */
goog.format.JsonPrettyPrinter.TextDelimiters.prototype.formatValue = function (value, typeOf) {
...
/** @override */
goog.format.JsonPrettyPrinter.SafeHtmlDelimiters.prototype.formatName = (name) => {
  var classes = goog.getCssName('goog-jsonprettyprinter-propertyname');
  return goog.html.SafeHtml.create('span', { class: classes }, name);
};

/** @override */
goog.format.JsonPrettyPrinter.SafeHtmlDelimiters.prototype.formatValue = function (value, typeOf) {
 ...
 * @protected
 */
goog.format.JsonPrettyPrinter.SafeHtmlDelimiters.prototype.getValueCssName = (typeOf) => {
