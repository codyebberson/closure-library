...
function assertParsedList(inputString, expectedList, opt_message) {
  ...
  assertEquals('Should have correct # of addresses', expectedList.length, result.length);
...
testSuite({
  ...
  testparseListWithQuotedSpecialChars() {
    const res = assertParsedList('a\\"b\\"c <d@e.f>,"g\\"h\\"i\\\\" <j@k.l>', ['d@e.f', 'j@k.l']);
  ...
  testparseListWithCommaInLocalPart() {
    const res = assertParsedList('"Doe, John" <doe.john@gmail.com>, <someone@gmail.com>', [
      'doe.john@gmail.com',
      'someone@gmail.com',
    ]);
  ...
  testparseListWithWhitespaceSeparatedEmails() {
    const res = assertParsedList('a@b.com <c@d.com> e@f.com "G H" <g@h.com> i@j.com', [
      'a@b.com',
      'c@d.com',
      'e@f.com',
      'g@h.com',
  ...
  testparseListSystemNewlines() {
    ...
    assertParsedList('a@b.com\nc@d.com', ['a@b.com', 'c@d.com'], 'Failed to parse *nix newlines');
    assertParsedList(
      'a@b.com\n\rc@d.com',
      ['a@b.com', 'c@d.com'],
  ...
  testparseListBidiMarks() {
    ...
    assertParsedList(
      `ab ${LRE}${PDF}${RLM}<${LRE}a@b.com${PDF}${RLM}>` + `${PDF}${RLM},c@d.com${PDF}${RLM} `,
      ['a@b.com', 'c@d.com']
    );
    assertParsedList(
  ...
  testToString() {
    ...
    assertEquals('"JOHN, Doe" <john@gmail.com>', f('JOHN, Doe <john@gmail.com>'));
    assertEquals('"JOHN(Johnny) Doe" <john@gmail.com>', f('JOHN(Johnny) Doe <john@gmail.com>'));
    assertEquals('"JOHN[Johnny] Doe" <john@gmail.com>', f('JOHN[Johnny] Doe <john@gmail.com>'));
    assertEquals('"JOHN@work Doe" <john@gmail.com>', f('JOHN@work Doe <john@gmail.com>'));
    assertEquals('"JOHN:theking Doe" <john@gmail.com>', f('JOHN:theking Doe <john@gmail.com>'));
    assertEquals('"JOHN\\\\ Doe" <john@gmail.com>', f('JOHN\\ Doe <john@gmail.com>'));
    assertEquals('"JOHN.com Doe" <john@gmail.com>', f('JOHN.com Doe <john@gmail.com>'));
  ...
  testIsValidDomainPart() {
    const valid = ['example.com', 'dept.example.org', 'long.domain.with.lots.of.dots'];
    const invalid = [
      '',
      '@has.an.at.sign',
      '..has.leading.dots',
