...
testSuite({
  ...
  testIsValidLocalPart() {
    ...
    doIsValidTest(InternationalizedEmailAddress.isValidLocalPartSpec, valid, invalid);
  },
  ...
  testIsValidDomainPart() {
    ...
    doIsValidTest(InternationalizedEmailAddress.isValidDomainPartSpec, valid, invalid);
  },
