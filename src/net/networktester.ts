 ...
 * @private
 */
goog.net.NetworkTester.prototype.logger_ = goog.log.getLogger('goog.net.NetworkTester');
...
goog.net.NetworkTester.prototype.startNextAttempt_ = function () {
  ...
  if (goog.net.NetworkTester.getNavigatorOffline_()) {
    ...
    goog.log.info(this.logger_, 'Loading image (attempt ' + this.attempt_ + ') at ' + this.uri_);
 ...
 * @private
 */
goog.net.NetworkTester.getNavigatorOffline_ = () =>
  navigator !== null && 'onLine' in navigator && !navigator.onLine;
