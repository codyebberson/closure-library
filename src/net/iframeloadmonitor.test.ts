...
testSuite({
  ...
  testIframeLoadMonitor_withContentCheck: () => {
    ...
    return Timer.promise(10)
      .then(() => {
        assertFalse('Monitor should not fire before content has loaded.', monitor.isLoaded());
