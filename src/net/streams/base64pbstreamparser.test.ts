...
const testMessage1 = {
  data: [
    ...
    0x00, // padding: ''
    0x12,
    0x17, // status: (23 bytes long sub-message)
    0x08,
    0xc8,
    0x01,
    0x12,
  ...
  parsed: [
    ...
    {
      2: [
        0x08, 0xc8, 0x01, 0x12, 0x12, 0x73, 0x6f, 0x6d, 0x65, 0x74, 0x68, 0x69, 0x6e, 0x67, 0x2d,
        0x69, 0x73, 0x2d, 0x77, 0x72, 0x6f, 0x6e, 0x67,
      ],
    },
  ],
};
...
testSuite({
  ...
  testMessagesInChunks /**
    ...
    // clang-format off
    const data = [
      0x0a, 0x03, 0x61, 0x62, 0x63, 0x0a, 0x03, 0x64, 0x65, 0x66, 0x12, 0x03, 0x67, 0x68, 0x69,
    ];
    // clang-format on
