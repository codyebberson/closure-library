...
function findNodeWithHierarchy() {
  ...
  assertEquals(String(TagName.DIV), testingDom.findTextNode('a', root).parentNode.tagName);
  assertEquals(String(TagName.P), testingDom.findTextNode('b', root).parentNode.tagName);
  assertEquals(String(TagName.SPAN), testingDom.findTextNode('c', root).parentNode.tagName);
  assertEquals(String(TagName.P), testingDom.findTextNode('d', root).parentNode.tagName);
  assertEquals(String(TagName.DIV), testingDom.findTextNode('e', root).parentNode.tagName);
}
...
testSuite({
  ...
  testFindNodeDuplicate() {
    ...
    assertEquals(
      'Should return first duplicate',
      testingDom.findTextNode('c', root),
      root.firstChild
    );
  },
  ...
  testAssertHtmlMatchesWithDifferentlyOrderedAttributes() {
    ...
    testingDom.assertHtmlContentsMatch('<div bar="b" class="className" foo="a"></div>', root, true);
  },
  ...
  testAssertHtmlMismatchWithDifferentAttributeNames() {
    ...
    const e = assertThrowsJsUnitException(
      /**
                                           ...
                                           */
      () => {
        testingDom.assertHtmlContentsMatch('<div foo="a" baz="b"></div>', root, true);
      }
    );
  ...
  testAssertHtmlMismatchWithDifferentClassNames() {
    ...
    const e = assertThrowsJsUnitException(
      /**
                                     ...
                                     */
      () => {
        testingDom.assertHtmlContentsMatch('<div class="className2"></div>', root, true);
      }
    );
    assertContains('Expected class was: className2, but actual class was: className1', e.message);
  },

  /** @suppress {checkTypes} suppression added to enable type checking */
  testAssertHtmlMatchesWithClassNameAndUserAgentSpecified() {
    root.innerHTML = '<div>' + (userAgent.GECKO ? '<div class="foo"></div>' : '') + '</div>';

    testingDom.assertHtmlContentsMatch('<div><div class="foo GECKO"></div></div>', root, true);
  },
  ...
  testAssertHtmlMatchesWithClassesInDifferentOrder() {
    ...
    testingDom.assertHtmlContentsMatch('<div class="class2 class1"></div>', root, true);
  },
  ...
  testAssertHtmlMismatchWithDifferentAttributeValues() {
    ...
    const e = assertThrowsJsUnitException(
      /**
                                           ...
                                           */
      () => {
        testingDom.assertHtmlContentsMatch('<div foo="a" bar="a"></div>', root, true);
      }
    );
  ...
  testAssertHtmlMismatchWhenIdIsSpecified() {
    ...
    assertContains('Expected to find attribute with name id, in element', e.message);
  ...
  testAssertHtmlMatchesWithWhitespaceAndNesting() {
    ...
    root.appendChild(
      dom.createDom(
        TagName.DIV,
        null,
        dom.createDom(TagName.B, null, '  A  '),
    ...
    root.appendChild(
      dom.createDom(
        TagName.DIV,
        null,
        dom.createDom(TagName.B, null, '  C  '),
        dom.createDom(TagName.B, null, '  D  ')
      )
    );

    testingDom.assertHtmlContentsMatch(
      '<div><b>  A  </b><b>  B  </b></div>' + '<div><b>  C  </b><b>  D  </b></div>',
      root
    );
    ...
    root.appendChild(
      dom.createDom(
        TagName.B,
        null,
        dom.createDom(TagName.B, null, dom.createDom(TagName.B, null, '  A  '))
      )
    );
    root.appendChild(dom.createDom(TagName.B, null, '  B  '));

    testingDom.assertHtmlContentsMatch('<b><b><b>  A  </b></b></b><b>  B  </b>', root);
    ...
    testingDom.assertHtmlContentsMatch('<div><b><b>  A  </b></b></div><b>  B  </b>', root);
  ...
  testAssertHtmlContentsMatchWithTemplate() {
    ...
    assertThrowsJsUnitException(
      /**
                                 ...
                                 */
      () => {
        testingDom.assertHtmlContentsMatch('<template><p id="bar">foo</p></template>', root, true);
      }
    );
    assertThrowsJsUnitException(
      /**
                                 ...
                                 */
      () => {
        testingDom.assertHtmlContentsMatch('<template><p>bar</p></template>', root, true);
      }
    );
  },
  ...
  testAssertHtmlContentsMatchWithNestedTemplate() {
    const nestedTemplate = '<template><br><template><br></template><br></template>';
  ...
  testAssertHtmlContentsMatchWithHttpCredentials() {
    ...
    assertThrowsJsUnitException(
      /**
                                 ...
                                 */
      () => {
        testingDom.assertHtmlContentsMatch('<img src="http://bar:baz@example.com">', root, true);
      }
    );
  },
  ...
  testAssertHtmlMatchesWithSvgAttributes() {
    testingDom.assertHtmlMatches('<svg height="10px"></svg>', '<svg height="10px"></svg>');
  },
