 ...
 */
goog.testing.jsunit.AUTO_RUN_ONLOAD = goog.define('goog.testing.jsunit.AUTO_RUN_ONLOAD', true);
 ...
 */
goog.testing.jsunit.AUTO_RUN_DELAY_IN_MS_DEFAULT = goog.define(
 ...
 */
goog.testing.jsunit.AUTO_RUN_DELAY_IN_MS = goog.testing.jsunit.AUTO_RUN_DELAY_IN_MS_DEFAULT;
...
(() => {
  ...
  window.onerror = (messageOrEvent, url, line) => {
    ...
    if (stack) {
      ...
      tr.logError('JS ERROR: ' + messageOrEvent + '\nURL: ' + url + '\nLine: ' + line + colstr);
    }
  };
