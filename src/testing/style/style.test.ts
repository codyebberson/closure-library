...
testSuite({
  ...
  testIsVisible() {
    assertTrue('The div should be detected as visible.', testingStyle.isVisible(div1));

    // Tests with hidden element
    style.setElementShown(div1, false /* display */);
    assertFalse('The div should be detected as not visible.', testingStyle.isVisible(div1));
  ...
  testIsOnScreen() {
    ...
    assertTrue('An element fully on the screen is on screen.', testingStyle.isOnScreen(el));
    ...
    assertFalse('An element not in the DOM is not on screen.', testingStyle.isOnScreen(el2));
  },
  ...
  testIntersects() {
    ...
    assertTrue('The divs should be determined to itersect.', testingStyle.intersects(div1, div2));
