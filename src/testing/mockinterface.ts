 ...
 */
goog.testing.MockInterface.prototype.$replay = () => {};

/**
 * Reset the mock.
 */
goog.testing.MockInterface.prototype.$reset = () => {};

/**
 * Waits for the Mock to gather expectations and then performs verify.
 * @return {!goog.Promise<undefined>}
 */
goog.testing.MockInterface.prototype.$waitAndVerify = () => {};

/**
 * Assert that the expected function calls match the actual calls.
 */
goog.testing.MockInterface.prototype.$verify = () => {};
