...
exports.getInstance = (ctor) => {
  assert(!Object.isSealed(ctor), 'Cannot use getInstance() with a sealed constructor.');
  ...
  assert(ctorWithInstance.hasOwnProperty(prop), 'Could not instantiate singleton.');
  return instance;
};
