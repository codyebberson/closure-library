 ...
 * @template T
 */
goog.functions.constant = (retValue) => () => retValue;

/**
 * Always returns false.
 * @type {function(...): boolean}
 */
goog.functions.FALSE = () => false;

/**
 * Always returns true.
 * @type {function(...): boolean}
 */
goog.functions.TRUE = () => true;

/**
 * Always returns `null`.
 * @type {function(...): null}
 */
goog.functions.NULL = () => null;

/**
 * Always returns `undefined`.
 * @type {function(...): undefined}
 */
goog.functions.UNDEFINED = () => undefined;
 ...
 * @template T
 */
goog.functions.identity = (opt_returnValue, var_args) => opt_returnValue;
 ...
 *     arguments.
 */
goog.functions.lock = (f, opt_numArgs) => {
 ...
 */
goog.functions.nth = (n) => () => arguments[n];
 ...
 */
goog.functions.partialRight = (fn, var_args) => {
 ...
 * @template T
 */
goog.functions.withReturnValue = (f, retValue) =>
 ...
 */
goog.functions.equalTo = (value, opt_useLooseComparison) => (other) =>
  opt_useLooseComparison ? value == other : value === other;
 ...
 * @template T
 */
goog.functions.compose = (fn, var_args) => {
 ...
 */
goog.functions.sequence = (var_args) => {
  const functions = arguments;
  const length = functions.length;
  return function () {
    let result;
 ...
 */
goog.functions.create = (constructor, var_args) => {
  /**
   * @constructor
   * @final
   */
 ...
 * @template T
 */
goog.functions.cacheReturnValue = (fn) => {
  let called = false;
  let value;
 ...
 * @template SCOPE
 */
goog.functions.debounce = (f, interval, opt_scope) => {
  let timeout = 0;
  return /** @type {function(...?)} */ (
    (var_args) => {
      goog.global.clearTimeout(timeout);
      const args = arguments;
      timeout = goog.global.setTimeout(() => {
 ...
 * @template SCOPE
 */
goog.functions.throttle = (f, interval, opt_scope) => {
  let timeout = 0;
 ...
 * @template SCOPE
 */
goog.functions.rateLimit = (f, interval, opt_scope) => {
  let timeout = 0;
