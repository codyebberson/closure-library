 ...
 */
goog.vec.vec2d.create = () => new Float64Array(2);
 ...
 * @return {!goog.vec.vec2d.Type} The new vec2d.
 */
goog.vec.vec2d.createFromArray = (vec) => {
 ...
 */
goog.vec.vec2d.createFromValues = (v0, v1) => {
 ...
 *     chained together.
 */
goog.vec.vec2d.setFromVec2d = (vec, src) => {
  vec[0] = src[0];
  vec[1] = src[1];
  return vec;
};
 ...
 *     chained together.
 */
goog.vec.vec2d.setFromVec2f = (vec, src) => {
  vec[0] = src[0];
  vec[1] = src[1];
  return vec;
};
 ...
 *     chained together.
 */
goog.vec.vec2d.setFromArray = (vec, src) => {
  vec[0] = src[0];
  vec[1] = src[1];
  return vec;
};
 ...
 *     chained together.
 */
goog.vec.vec2d.add = (vec0, vec1, resultVec) => {
 ...
 *     chained together.
 */
goog.vec.vec2d.subtract = (vec0, vec1, resultVec) => {
  resultVec[0] = vec0[0] - vec1[0];
  resultVec[1] = vec0[1] - vec1[1];
  return resultVec;
};
 ...
 *     chained together.
 */
goog.vec.vec2d.componentMultiply = (vec0, vec1, resultVec) => {
  resultVec[0] = vec0[0] * vec1[0];
  resultVec[1] = vec0[1] * vec1[1];
  return resultVec;
};
 ...
 *     chained together.
 */
goog.vec.vec2d.componentDivide = (vec0, vec1, resultVec) => {
  resultVec[0] = vec0[0] / vec1[0];
  resultVec[1] = vec0[1] / vec1[1];
  return resultVec;
};
 ...
 *     chained together.
 */
goog.vec.vec2d.negate = (vec0, resultVec) => {
  resultVec[0] = -vec0[0];
  resultVec[1] = -vec0[1];
  return resultVec;
};
 ...
 *     chained together.
 */
goog.vec.vec2d.abs = (vec0, resultVec) => {
 ...
 *     chained together.
 */
goog.vec.vec2d.scale = (vec0, scalar, resultVec) => {
 ...
 */
goog.vec.vec2d.magnitudeSquared = (vec0) => {
  const x = vec0[0];
  const y = vec0[1];
 ...
 *     chained together.
 */
goog.vec.vec2d.normalize = (vec0, resultVec) => {
  const x = vec0[0];
  const y = vec0[1];
 ...
 */
goog.vec.vec2d.dot = (vec0, vec1) => vec0[0] * vec1[0] + vec0[1] * vec1[1];
 ...
 */
goog.vec.vec2d.distanceSquared = (vec0, vec1) => {
 ...
 */
goog.vec.vec2d.distance = (vec0, vec1) => Math.sqrt(goog.vec.vec2d.distanceSquared(vec0, vec1));
 ...
 *     chained together.
 */
goog.vec.vec2d.direction = (vec0, vec1, resultVec) => {
 ...
 *     chained together.
 */
goog.vec.vec2d.lerp = (vec0, vec1, f, resultVec) => {
  const x = vec0[0];
  const y = vec0[1];
 ...
 *     chained together.
 */
goog.vec.vec2d.max = (vec0, limit, resultVec) => {
 ...
 *     chained together.
 */
goog.vec.vec2d.min = (vec0, limit, resultVec) => {
  if (typeof limit === 'number') {
 ...
 */
goog.vec.vec2d.equals = (vec0, vec1) =>
