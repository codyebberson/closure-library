 ...
 */
goog.vec.mat3f.create = () => new Float32Array(9);
 ...
 *     chained together.
 */
goog.vec.mat3f.setFromValues = (mat, v00, v10, v20, v01, v11, v21, v02, v12, v22) => {
  mat[0] = v00;
  mat[1] = v10;
  mat[2] = v20;
  mat[3] = v01;
 ...
 *     chained together.
 */
goog.vec.mat3f.setFromMat3f = (mat, src) => {
  mat[0] = src[0];
  mat[1] = src[1];
  mat[2] = src[2];
  mat[3] = src[3];
 ...
 *     chained together.
 */
goog.vec.mat3f.setFromMat3d = (mat, src) => {
  mat[0] = src[0];
  mat[1] = src[1];
  mat[2] = src[2];
  mat[3] = src[3];
 ...
 *     chained together.
 */
goog.vec.mat3f.setFromArray = (mat, src) => {
  mat[0] = src[0];
  mat[1] = src[1];
  mat[2] = src[2];
  mat[3] = src[3];
 ...
 */
goog.vec.mat3f.getElement = (mat, row, column) => mat[row + column * 3];
 ...
 *     chained together.
 */
goog.vec.mat3f.setElement = (mat, row, column, value) => {
 ...
 *     chained together.
 */
goog.vec.mat3f.setDiagonalValues = (mat, v00, v11, v22) => {
  mat[0] = v00;
  mat[4] = v11;
  mat[8] = v22;
  return mat;
 ...
 *     chained together.
 */
goog.vec.mat3f.setDiagonal = (mat, vec) => {
  mat[0] = vec[0];
  mat[4] = vec[1];
  mat[8] = vec[2];
  return mat;
 ...
 *     chained together.
 */
goog.vec.mat3f.setColumnValues = (mat, column, v0, v1, v2) => {
  const i = column * 3;
  mat[i] = v0;
  mat[i + 1] = v1;
  mat[i + 2] = v2;
 ...
 *     chained together.
 */
goog.vec.mat3f.setColumn = (mat, column, vec) => {
  const i = column * 3;
  mat[i] = vec[0];
  mat[i + 1] = vec[1];
  mat[i + 2] = vec[2];
 ...
 *     chained together.
 */
goog.vec.mat3f.getColumn = (mat, column, vec) => {
  const i = column * 3;
  vec[0] = mat[i];
  vec[1] = mat[i + 1];
  vec[2] = mat[i + 2];
 ...
 *     chained together.
 */
goog.vec.mat3f.setColumns = (mat, vec0, vec1, vec2) => {
 ...
 */
goog.vec.mat3f.getColumns = (mat, vec0, vec1, vec2) => {
 ...
 *     chained together.
 */
goog.vec.mat3f.setRowValues = (mat, row, v0, v1, v2) => {
  mat[row] = v0;
  mat[row + 3] = v1;
  mat[row + 6] = v2;
  return mat;
 ...
 *     chained together.
 */
goog.vec.mat3f.setRow = (mat, row, vec) => {
  mat[row] = vec[0];
  mat[row + 3] = vec[1];
  mat[row + 6] = vec[2];
  return mat;
 ...
 *     chained together.
 */
goog.vec.mat3f.getRow = (mat, row, vec) => {
  vec[0] = mat[row];
  vec[1] = mat[row + 3];
  vec[2] = mat[row + 6];
  return vec;
 ...
 *     chained together.
 */
goog.vec.mat3f.setRows = (mat, vec0, vec1, vec2) => {
 ...
 */
goog.vec.mat3f.getRows = (mat, vec0, vec1, vec2) => {
 ...
 *     chained together.
 */
goog.vec.mat3f.addMat = (mat0, mat1, resultMat) => {
 ...
 *     chained together.
 */
goog.vec.mat3f.subMat = (mat0, mat1, resultMat) => {
  resultMat[0] = mat0[0] - mat1[0];
  resultMat[1] = mat0[1] - mat1[1];
  resultMat[2] = mat0[2] - mat1[2];
  resultMat[3] = mat0[3] - mat1[3];
 ...
 *     chained together.
 */
goog.vec.mat3f.multScalar = (mat, scalar, resultMat) => {
 ...
 *     chained together.
 */
goog.vec.mat3f.multMat = (mat0, mat1, resultMat) => {
  const a00 = mat0[0];
  const a10 = mat0[1];
  const a20 = mat0[2];
 ...
 *     chained together.
 */
goog.vec.mat3f.transpose = (mat, resultMat) => {
  if (resultMat == mat) {
    const a10 = mat[1];
    const a20 = mat[2];
    const a21 = mat[5];
 ...
 */
goog.vec.mat3f.invert = (mat0, resultMat) => {
  const a00 = mat0[0];
  const a10 = mat0[1];
  const a20 = mat0[2];
 ...
 */
goog.vec.mat3f.equals = (mat0, mat1) =>
 ...
 *     chained together.
 */
goog.vec.mat3f.multVec3 = (mat, vec, resultVec) => {
  const x = vec[0];
  const y = vec[1];
  const z = vec[2];
 ...
 *     chained.
 */
goog.vec.mat3f.makeTranslate = (mat, x, y) => {
  mat[0] = 1;
  mat[1] = 0;
  mat[2] = 0;
  mat[3] = 0;
 ...
 *     chained.
 */
goog.vec.mat3f.makeScale = (mat, x, y, z) => {
  mat[0] = x;
  mat[1] = 0;
  mat[2] = 0;
  mat[3] = 0;
 ...
 *     chained.
 */
goog.vec.mat3f.makeRotate = (mat, angle, ax, ay, az) => {
 ...
 *     chained.
 */
goog.vec.mat3f.makeRotateX = (mat, angle) => {
  const c = Math.cos(angle);
  const s = Math.sin(angle);
 ...
 *     chained.
 */
goog.vec.mat3f.makeRotateY = (mat, angle) => {
  const c = Math.cos(angle);
  const s = Math.sin(angle);
 ...
 *     chained.
 */
goog.vec.mat3f.makeRotateZ = (mat, angle) => {
  const c = Math.cos(angle);
  const s = Math.sin(angle);
 ...
 *     chained.
 */
goog.vec.mat3f.rotate = (mat, angle, x, y, z) => {
  const m00 = mat[0];
  const m10 = mat[1];
  const m20 = mat[2];
 ...
 *     chained.
 */
goog.vec.mat3f.rotateX = (mat, angle) => {
  const m01 = mat[3];
  const m11 = mat[4];
  const m21 = mat[5];
 ...
 *     chained.
 */
goog.vec.mat3f.rotateY = (mat, angle) => {
  const m00 = mat[0];
  const m10 = mat[1];
  const m20 = mat[2];
 ...
 *     chained.
 */
goog.vec.mat3f.rotateZ = (mat, angle) => {
  const m00 = mat[0];
  const m10 = mat[1];
  const m20 = mat[2];
 ...
 *     chained.
 */
goog.vec.mat3f.makeEulerZXZ = (mat, theta1, theta2, theta3) => {
 ...
 *     chained together.
 */
goog.vec.mat3f.toEulerZXZ = (mat, euler, opt_theta2IsNegative) => {
