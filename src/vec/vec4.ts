 ...
 */
goog.vec.Vec4.createFloat32 = () => new Float32Array(4);
 ...
 */
goog.vec.Vec4.createFloat64 = () => new Float64Array(4);
 ...
 */
goog.vec.Vec4.create = () => new Float32Array(4);
 ...
 * @return {!goog.vec.Vec4.Type} The new 4 element array.
 */
goog.vec.Vec4.createFromArray = (vec) => {
 ...
 * @return {!goog.vec.Vec4.Float32} The new 3 element array.
 */
goog.vec.Vec4.createFloat32FromArray = (vec) => {
 ...
 */
goog.vec.Vec4.createFloat32FromValues = (v0, v1, v2, v3) => {
 ...
 * @return {!goog.vec.Vec4.Float64} The new 4 element array.
 */
goog.vec.Vec4.createFloat64FromArray = (vec) => {
 ...
 */
goog.vec.Vec4.createFloat64FromValues = (v0, v1, v2, v3) => {
 ...
 */
goog.vec.Vec4.createFromValues = (v0, v1, v2, v3) => {
 ...
 *     chained together.
 */
goog.vec.Vec4.setFromArray = (vec, values) => {
  vec[0] = values[0];
  vec[1] = values[1];
  vec[2] = values[2];
  vec[3] = values[3];
 ...
 *     chained together.
 */
goog.vec.Vec4.add = (vec0, vec1, resultVec) => {
 ...
 *     chained together.
 */
goog.vec.Vec4.subtract = (vec0, vec1, resultVec) => {
  resultVec[0] = vec0[0] - vec1[0];
  resultVec[1] = vec0[1] - vec1[1];
  resultVec[2] = vec0[2] - vec1[2];
  resultVec[3] = vec0[3] - vec1[3];
 ...
 *     chained together.
 */
goog.vec.Vec4.negate = (vec0, resultVec) => {
  resultVec[0] = -vec0[0];
  resultVec[1] = -vec0[1];
  resultVec[2] = -vec0[2];
  resultVec[3] = -vec0[3];
 ...
 *     chained together.
 */
goog.vec.Vec4.abs = (vec0, resultVec) => {
 ...
 *     chained together.
 */
goog.vec.Vec4.scale = (vec0, scalar, resultVec) => {
 ...
 */
goog.vec.Vec4.magnitudeSquared = (vec0) => {
  const w = vec0[3];
  const x = vec0[0];
  const y = vec0[1];
  const z = vec0[2];
 ...
 *     chained together.
 */
goog.vec.Vec4.normalize = (vec0, resultVec) => {
 ...
 */
goog.vec.Vec4.dot = (v0, v1) => v0[0] * v1[0] + v0[1] * v1[1] + v0[2] * v1[2] + v0[3] * v1[3];
 ...
 *     chained together.
 */
goog.vec.Vec4.lerp = (v0, v1, f, resultVec) => {
  const w = v0[3];
  const x = v0[0];
  const y = v0[1];
  const z = v0[2];
 ...
 *     chained together.
 */
goog.vec.Vec4.max = (vec0, limit, resultVec) => {
 ...
 *     chained together.
 */
goog.vec.Vec4.min = (vec0, limit, resultVec) => {
  if (typeof limit === 'number') {
 ...
 */
goog.vec.Vec4.equals = (v0, v1) =>
  v0.length == v1.length && v0[0] == v1[0] && v0[1] == v1[1] && v0[2] == v1[2] && v0[3] == v1[3];
