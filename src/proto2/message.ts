...
goog.proto2.Message.prototype.setUnknown = function (tag, value) {
  ...
  goog.asserts.assert(
    tag >= 1,
    'Tag ' + tag + ' has value "' + value + '" in descriptor ' + this.getDescriptor().getName()
  );
...
goog.proto2.Message.prototype.equals = function (other) {
  ...
  for (var i = 0; i < fields.length; i++) {
    ...
    if (this.has$Value(tag)) {
      ...
      var fieldsEqual = (value1, value2) =>
        isComposite ? value1.equals(value2) : value1 == value2;
 ...
 * @private
 */
goog.proto2.Message.prototype.checkFieldType_ = (field, value) => {
 ...
 */
goog.proto2.Message.createDescriptor = (messageType, metadataObj) => {
  var fields = [];
