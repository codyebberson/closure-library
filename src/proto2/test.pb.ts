...
proto2.TestAllTypes.prototype.getDescriptor = () => {
  ...
  if (!descriptor) {
    ...
    proto2.TestAllTypes.descriptor_ = descriptor = goog.proto2.Message.createDescriptor(
      proto2.TestAllTypes,
      descriptorObj
    );
  }
...
/** @nocollapse */
proto2.TestAllTypes.getDescriptor = proto2.TestAllTypes.prototype.getDescriptor;
...
proto2.TestAllTypes.NestedMessage.prototype.getDescriptor = () => {
  ...
  if (!descriptor) {
    ...
    proto2.TestAllTypes.NestedMessage.descriptor_ = descriptor =
      goog.proto2.Message.createDescriptor(proto2.TestAllTypes.NestedMessage, descriptorObj);
  }
  return descriptor;
};
...
proto2.TestAllTypes.OptionalGroup.prototype.getDescriptor = () => {
  ...
  if (!descriptor) {
    ...
    proto2.TestAllTypes.OptionalGroup.descriptor_ = descriptor =
      goog.proto2.Message.createDescriptor(proto2.TestAllTypes.OptionalGroup, descriptorObj);
  }
  return descriptor;
};
...
proto2.TestAllTypes.RepeatedGroup.prototype.getDescriptor = () => {
  ...
  if (!descriptor) {
    ...
    proto2.TestAllTypes.RepeatedGroup.descriptor_ = descriptor =
      goog.proto2.Message.createDescriptor(proto2.TestAllTypes.RepeatedGroup, descriptorObj);
  }
  return descriptor;
};
...
proto2.TestDefaultParent.prototype.getDescriptor = () => {
  ...
  if (!descriptor) {
    ...
    proto2.TestDefaultParent.descriptor_ = descriptor = goog.proto2.Message.createDescriptor(
...
/** @nocollapse */
proto2.TestDefaultParent.getDescriptor = proto2.TestDefaultParent.prototype.getDescriptor;
...
proto2.TestDefaultChild.prototype.getDescriptor = () => {
  ...
  if (!descriptor) {
    ...
    proto2.TestDefaultChild.descriptor_ = descriptor = goog.proto2.Message.createDescriptor(
...
/** @nocollapse */
proto2.TestDefaultChild.getDescriptor = proto2.TestDefaultChild.prototype.getDescriptor;
