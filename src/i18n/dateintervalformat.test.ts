...
if (!browser.isIE()) {
  if (Intl && Intl.DateTimeFormat && Intl.ListFormat.supportedLocalesOf(['en'])) {
...
function driveTests(locale, symbols, testCallbackFn) {
  ...
  for (const nativeMode of testECMAScriptOptions) {
    ...
    propertyReplacer.replace(LocaleFeature, 'USE_ECMASCRIPT_I18N_DATEINTERVALFORMAT', nativeMode);
...
const formatTestData = [
  new Data(
    ...
    [2007, 0, 10, 10, 10, 10],
    [2007, 0, 10, 10, 10, 20],
    dateIntervalPatterns.DateIntervalPatterns_en.YEAR_FULL,
    '2007'
  ),
  new Data(
    'en',
  ...
  new Data(
    ...
    [2007, 0, 10, 10, 10, 10],
    [2007, 0, 10, 10, 10, 20],
    dateIntervalPatterns.DateIntervalPatterns_en.MONTH_DAY_FULL,
    'January 10'
  ),
  new Data(
    'en',
  ...
  new Data(
    ...
    [2007, 0, 10, 10, 10, 10],
    [2007, 0, 10, 10, 10, 20],
    dateIntervalPatterns.DateIntervalPatterns_en.DAY_ABBR,
    '10'
  ),
  new Data(
    'en',
  ...
  new Data(
    ...
    [2007, 0, 10, 10, 10, 10],
    [2007, 0, 10, 10, 10, 20],
    dateIntervalPatterns.DateIntervalPatterns_en.WEEKDAY_MONTH_DAY_YEAR_MEDIUM,
    'Wed, Jan 10, 2007'
  ),
  new Data(
    'en',
  ...
  new Data(
    ...
    [2007, 0, 10, 10, 10, 10],
    [2007, 0, 10, 10, 10, 20],
    DateTimeFormat.Format.SHORT_DATETIME,
    '1/10/07, 10:10 AM'
  ),
  new Data(
    'en',
  ...
  new Data(
    ...
    [2007, 10, 20, 10, 10, 10],
    DateTimeFormat.Format.SHORT_DATETIME,
    '11/10/07, 10:10 AM – 11/20/07, 10:10 AM'
  ),
  new Data(
    'en',
    [2007, 9, 10, 10, 10, 10],
    [2007, 10, 10, 10, 10, 10],
    DateTimeFormat.Format.SHORT_DATETIME,
    '10/10/07, 10:10 AM – 11/10/07, 10:10 AM'
  ),
  new Data(
    'en',
    [2007, 9, 10, 10, 10, 10],
    [2008, 9, 10, 10, 10, 10],
    DateTimeFormat.Format.SHORT_DATETIME,
    '10/10/07, 10:10 AM – 10/10/08, 10:10 AM'
  ),
  ...
  new Data(
    ...
    [2007, 0, 10, 10, 10, 10],
    [2007, 0, 10, 10, 10, 20],
    dateIntervalPatterns.DateIntervalPatterns_ar_EG.MONTH_DAY_ABBR,
    '١٠ يناير'
  ),
  new Data(
    'ar_EG',
  ...
  new Data(
    ...
    [2022, 10, 8, 10, 10, 10],
    [2023, 1, 5, 10, 10, 10],
    dateIntervalPatterns.DateIntervalPatterns_hi.MONTH_DAY_MEDIUM,
    '8 thg 11 2022–5 thg 2 2023'
  ),
  ...
  new Data(
    ...
    [2007, 0, 10, 10, 10, 10],
    [2007, 0, 10, 10, 10, 20],
    dateIntervalPatterns.DateIntervalPatterns_fr_CA.MONTH_DAY_MEDIUM,
    '10 janv.'
  ),
  new Data(
    'fr_CA',
  ...
  new Data(
    ...
    [2007, 0, 10, 10, 10, 10],
    [2007, 0, 10, 10, 10, 20],
    dateIntervalPatterns.DateIntervalPatterns_gl.YEAR_MONTH_FULL,
    'xaneiro de 2007'
  ),
  new Data(
    'gl',
  ...
  new Data(
    ...
    [2007, 0, 10, 10, 10, 10],
    [2007, 0, 10, 10, 10, 20],
    dateIntervalPatterns.DateIntervalPatterns_fr_CA.YEAR_MONTH_SHORT,
    '2007-01'
  ),
  new Data(
    'fr_CA',
  ...
  new Data(
    ...
    [2007, 0, 10, 10, 10, 10],
    [2007, 0, 10, 10, 10, 20],
    dateIntervalPatterns.DateIntervalPatterns_zh.WEEKDAY_MONTH_DAY_YEAR_MEDIUM,
    '2007年1月10日周三'
  ),
  new Data(
    'zh',
...
testSuite({
  ...
  testNewYearFormat: () => {
    driveTests(
      ...
      (nativeMode) => {
        ...
        const tz = TimeZone.createTimeZone(tzMinuteOffset);
        const result = removeWhitespace(fmt.format(dt1, dt2, tz));
        ...
        const result3 = removeWhitespace(fmt.format(dt1, dt2, tz2));
  ...
  testTimeZone: () => {
    driveTests(
      ...
      (nativeMode) => {
        ...
        assertI18nEquals(
          'nativeMode=' + nativeMode + ' version=' + browser.getVersion(),
          '2:00:23 AM UTC-4 – 2:20:23 AM UTC-4',
          result
        );
      }
    );
  ...
  testFormatSecondDateWithFirstPattern: () => {
    driveTests(
      'en',
      DateTimeSymbols_en,
      /** @param {boolean} nativeMode */
      (nativeMode) => {
         ...
         */
        const fmt = new DateIntervalFormat(DateTimeFormat.Format.LONG_DATE, symbols);
  ...
  testGetLargestDifferentCalendarField: () => {
    driveTests(
      'en',
      DateTimeSymbols_en,
      /** @param {boolean} nativeMode */
      (nativeMode) => {
         ...
         */
        let calField = DateIntervalFormat.getLargestDifferentCalendarField_(dt1, dt2);
         ...
         * @suppress {visibility} suppression added to enable type checking
         */
        calField = DateIntervalFormat.getLargestDifferentCalendarField_(dt1, dt2, tz);
        assertEquals('a', calField);
        // Seconds
