...
const localeSymbols = {
  en: {
    RelativeDateTimeFormatSymbols: relativeDateTimeSymbols.RelativeDateTimeSymbols_en,
  },
  es: {
    RelativeDateTimeFormatSymbols: relativeDateTimeSymbols.RelativeDateTimeSymbols_es,
  },
  fr: {
    RelativeDateTimeFormatSymbols: relativeDateTimeSymbols.RelativeDateTimeSymbols_fr,
  },
  ar: {
    RelativeDateTimeFormatSymbols: relativeDateTimeSymbols.RelativeDateTimeSymbols_ar,
  },
  ar_EG: {
    RelativeDateTimeFormatSymbols: relativeDateTimeSymbols.RelativeDateTimeSymbols_ar_EG,
  },
  ar_LY: {
    RelativeDateTimeFormatSymbols: relativeDateTimeSymbolsExt.RelativeDateTimeSymbols_ar_LY,
  },
  agq: {
    RelativeDateTimeFormatSymbols: relativeDateTimeSymbolsExt.RelativeDateTimeSymbols_agq,
  },
  ar_AE: {
    RelativeDateTimeFormatSymbols: relativeDateTimeSymbolsExt.RelativeDateTimeSymbols_ar_AE,
  },
  as: {
    RelativeDateTimeFormatSymbols: relativeDateTimeSymbolsExt.RelativeDateTimeSymbols_as,
  },
  fa: {
    RelativeDateTimeFormatSymbols: relativeDateTimeSymbols.RelativeDateTimeSymbols_fa,
  },
  he: {
    RelativeDateTimeFormatSymbols: relativeDateTimeSymbols.RelativeDateTimeSymbols_he,
  },
};
...
const formatDirectionTestData = [
  new DirectionData(
    'en',
    RelativeDateTimeFormat.Style.LONG,
    -1,
    RelativeDateTimeFormat.Unit.DAY,
    'yesterday'
  ),
  new DirectionData(
    'en',
  ...
  new DirectionData(
    'en',
    RelativeDateTimeFormat.Style.NARROW,
    -2,
    RelativeDateTimeFormat.Unit.DAY,
    '2d ago'
  ),
  new DirectionData(
    ...
    RelativeDateTimeFormat.Style.LONG,
    -2,
    RelativeDateTimeFormat.Unit.WEEK,
    '2 weeks ago'
  ),
  new DirectionData(
    'en',
  ...
  new DirectionData(
    ...
    RelativeDateTimeFormat.Style.LONG,
    1,
    RelativeDateTimeFormat.Unit.SECOND,
    'in 1 second'
  ),
  new DirectionData(
    'en',
  ...
  new DirectionData(
    ...
    RelativeDateTimeFormat.Style.LONG,
    1,
    RelativeDateTimeFormat.Unit.MINUTE,
    'in 1 minute'
  ),
  new DirectionData(
    'en',
  ...
  new DirectionData(
    ...
    RelativeDateTimeFormat.Style.LONG,
    1,
    RelativeDateTimeFormat.Unit.HOUR,
    'in 1 hour'
  ),
  new DirectionData(
    'en',
  ...
  new DirectionData(
    ...
    RelativeDateTimeFormat.Style.LONG,
    1,
    RelativeDateTimeFormat.Unit.MONTH,
    'next month'
  ),
  new DirectionData(
    'en',
    RelativeDateTimeFormat.Style.LONG,
    1,
    RelativeDateTimeFormat.Unit.QUARTER,
    'next quarter'
  ),
  new DirectionData(
    'en',
  ...
  new DirectionData(
    ...
    RelativeDateTimeFormat.Style.LONG,
    2,
    RelativeDateTimeFormat.Unit.YEAR,
    'in 2 years'
  ),
  new DirectionData(
    'en',
...
const formatNumericSpanishData = [
  ...
  new DirectionData('es', RelativeDateTimeFormat.Style.SHORT, -2, RelativeDateTimeFormat.Unit.DAY, [
    'hace 2 d',
    'hace 2 días',
  ]), // CLDR 40 added new short form
  new DirectionData('es', RelativeDateTimeFormat.Style.SHORT, 3, RelativeDateTimeFormat.Unit.DAY, [
    'dentro de 3 d',
    'dentro de 3 días',
  ]), // CLDR 40 added new short form
];
...
testSuite({
  getTestName: () => 'RelativeDateTimeFormat Tests',
  ...
  testFormatNumericStyle: () => {
    for (const val of testECMAScriptOptions) {
      ...
      for (let i = 0; i < formatNumericTestData.length; i++) {
        ...
        assertI18n.assertI18nEquals(data.getErrorDescription(), data.expected, result);
  ...
  testNumericMode: () => {
    for (const val of testECMAScriptOptions) {
      ...
      assertEquals(data.getErrorDescription(), numMode, RelativeDateTimeFormat.NumericOption.AUTO);
      /** @suppress {checkTypes} suppression added to enable type checking */
      const result = fmt.format(data.direction, data.unit);
    ...
    for (const val of testECMAScriptOptions) {
      ...
      for (let i = 0; i < formatNumericSpanishData.length; i++) {
        ...
        if (Array.isArray(data.expected)) {
          ...
          assertTrue(data.getErrorDescription(), data.expected.includes(result));
        } else {
          assertEquals(data.getErrorDescription(), data.expected, result);
        }
      }
  ...
  testFormatNumericExtendedStyle: () => {
    for (const val of testECMAScriptOptions) {
      propertyReplacer.replace(LocaleFeature, 'USE_ECMASCRIPT_I18N_RDTF', val);
  ...
  testGetStyle: () => {
    for (const val of testECMAScriptOptions) {
      ...
      assertEquals('bad style returned', RelativeDateTimeFormat.Style.LONG, style);

      fmt = new RelativeDateTimeFormat(undefined, RelativeDateTimeFormat.Style.LONG);
      style = fmt.getFormatStyle();
      assertEquals('bad style returned', RelativeDateTimeFormat.Style.LONG, style);

      fmt = new RelativeDateTimeFormat(undefined, RelativeDateTimeFormat.Style.SHORT);
      style = fmt.getFormatStyle();
      assertEquals('bad style returned', RelativeDateTimeFormat.Style.SHORT, style);

      fmt = new RelativeDateTimeFormat(undefined, RelativeDateTimeFormat.Style.NARROW);
      style = fmt.getFormatStyle();
      assertEquals('bad style returned', RelativeDateTimeFormat.Style.NARROW, style);
    }
  },

  // Test that retrieving relative unit is returned when defined only.
  testGetRelativeStringDefined: () => {
    for (const val of testECMAScriptOptions) {
      propertyReplacer.replace(LocaleFeature, 'USE_ECMASCRIPT_I18N_RDTF', val);
      ...
      if (!fmt.isNativeMode()) {
        ...
        let result = fmt.isOffsetDefinedForUnit(RelativeDateTimeFormat.Unit.DAY, -7);
        ...
        result = fmt.isOffsetDefinedForUnit(RelativeDateTimeFormat.Unit.MONTH, -1);
