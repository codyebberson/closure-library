...
exports.ECMASCRIPT_LISTFORMAT_COMMON_LOCALES_2022 =
  ...
  goog.LOCALE === 'sr' ||
  goog.LOCALE === 'sr-Cyrl' ||
  goog.LOCALE === 'sr-Cyrl-BA' ||
  goog.LOCALE === 'sr-Cyrl-ME' ||
  goog.LOCALE === 'sr-Cyrl-RS' ||
  goog.LOCALE === 'sr-Cyrl-XK' ||
  goog.LOCALE === 'sr-Latn' ||
  goog.LOCALE === 'sr-Latn-BA' ||
  goog.LOCALE === 'sr-Latn-ME' ||
  goog.LOCALE === 'sr-Latn-RS' ||
  goog.LOCALE === 'sr-Latn-XK' ||
  goog.LOCALE === 'sv' ||
  goog.LOCALE === 'sv-AX' ||
  goog.LOCALE === 'sv-FI' ||
  goog.LOCALE === 'sv-SE' ||
  ...
  goog.LOCALE === 'zh' ||
  goog.LOCALE === 'zh-Hans' ||
  goog.LOCALE === 'zh-Hans-CN' ||
  goog.LOCALE === 'zh-Hans-HK' ||
  goog.LOCALE === 'zh-Hans-MO' ||
  goog.LOCALE === 'zh-Hans-SG' ||
  goog.LOCALE === 'zh-Hant' ||
  goog.LOCALE === 'zh-Hant-HK' ||
  goog.LOCALE === 'zh-Hant-MO' ||
