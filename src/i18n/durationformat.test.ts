...
const { DurationFormat, DurationFormatStyle, DurationFormatUnit } = goog.require(
  'goog.i18n.DurationFormat'
);
...
const durationTestENData = [
  new DurationData(
    'en',
    DurationFormatStyle.LONG,
    1,
    DurationFormatUnit.YEAR,
    '1 year',
    Plurals_en(1)
  ),
  new DurationData(
...
const durationTestEXTData = [
  new DurationData('agq', DurationFormatStyle.SHORT, 2, DurationFormatUnit.DAY, '2 d', Plurals(2)),
  new DurationData('agq', DurationFormatStyle.LONG, 1, DurationFormatUnit.DAY, '1 d', Plurals(1)),
  new DurationData('agq', DurationFormatStyle.LONG, 3, DurationFormatUnit.DAY, '3 d', Plurals(3)),
  new DurationData('agq', DurationFormatStyle.SHORT, 1, DurationFormatUnit.DAY, '1 d', Plurals(1)),
  new DurationData('as', DurationFormatStyle.LONG, 1, DurationFormatUnit.DAY, '1 দিন', Plurals(1)),
  new DurationData('as', DurationFormatStyle.LONG, 2, DurationFormatUnit.DAY, '2 দিন', Plurals(2)),
  new DurationData(
    'as',
    DurationFormatStyle.SHORT,
    1,
...
testSuite({
  getTestName: () => 'DurationFormat Tests',
  ...
  testFormatStyle: () => {
    for (let i = 0; i < durationTestENData.length; i++) {
       ...
       * checking
       */
      const fmt = new DurationFormat({ style: data.style }, symbols.DurationSymbols);
      const durationdata = {};
  ...
  testMultiUnitsFormatShortStyle: () => {
    goog['LOCALE'] = 'en';
  ...
  testMultiUnitsFormatNarrowStyle: () => {
    goog['LOCALE'] = 'en';
  ...
  testAFMultiUnitsFormat: () => {
    ...
    const fmt = new DurationFormat(
      { style: DurationFormatStyle.LONG },
      DurationSymbols.DurationSymbols_af
    );
