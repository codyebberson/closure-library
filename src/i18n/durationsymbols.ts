...
exports.DurationSymbols_cy = {
  DAY: {
    ...
    SHORT:
      'zero{# diwrnod}one{# diwrnod}two{# ddiwrnod}few{# diwrnod}many{# diwrnod}other{# diwrnod}',
