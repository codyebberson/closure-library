...
goog.ui.CheckboxRenderer.prototype.createDom = function (checkbox) {
  var element = checkbox
    .getDomHelper()
    .createDom(goog.dom.TagName.SPAN, this.getClassNames(checkbox).join(' '));
 ...
 * @override
 */
goog.ui.CheckboxRenderer.prototype.getAriaRole = () => goog.a11y.aria.Role.CHECKBOX;
 ...
 * @private
 */
goog.ui.CheckboxRenderer.prototype.ariaStateFromCheckState_ = (state) => {
...
/** @override */
goog.ui.CheckboxRenderer.prototype.getCssClass = () => goog.ui.CheckboxRenderer.CSS_CLASS;
