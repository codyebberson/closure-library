...
goog.ui.emoji.PopupEmojiPicker.prototype.createDom = function () {
  ...
  this.getElement().appendChild(/** @type {!Node} */ (this.emojiPicker_.getElement()));
...
goog.ui.emoji.PopupEmojiPicker.prototype.show_ = function (e) {
  ...
  this.popup_.setPosition(
    new goog.positioning.AnchoredPosition(this.lastTarget_, goog.positioning.Corner.BOTTOM_LEFT)
  );
