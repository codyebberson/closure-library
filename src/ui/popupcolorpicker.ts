 ...
 * @override
 */
goog.ui.PopupColorPicker.prototype.canDecorate = (element) => false;
 ...
 */
goog.ui.PopupColorPicker.prototype.addColors = (colors) => {};

/**
 * Clear the colors displayed by the color picker.
 */
goog.ui.PopupColorPicker.prototype.clearColors = () => {};
...
goog.ui.PopupColorPicker.prototype.show_ = function (e) {
  if (!this.initialized_) {
    this.colorPicker_ =
      this.colorPicker_ || goog.ui.ColorPicker.createSimpleColorGrid(this.getDomHelper());
  ...
  if (
    this.popup_.isOrWasRecentlyVisible() &&
    this.toggleMode_ &&
  ...
  this.popup_.setPosition(
    new goog.positioning.AnchoredPosition(this.lastTarget_, this.popupCorner_)
  );
