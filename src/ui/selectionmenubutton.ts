...
goog.ui.SelectionMenuButton.prototype.handleMouseDown = function (e) {
  if (!this.getDomHelper().contains(this.getCheckboxElement(), /** @type {Element} */ (e.target))) {
...
goog.ui.SelectionMenuButton.prototype.handleCheckboxClick = function (e) {
  if (this.selectionState == goog.ui.SelectionMenuButton.SelectionState.NONE) {
    ...
    if (this.getItemAt(0)) {
      this.getItemAt(0).dispatchEvent(
        // 'All' item
    ...
    if (this.getItemAt(1)) {
      this.getItemAt(1).dispatchEvent(
        // 'None' item
        goog.ui.Component.EventType.ACTION
      );
    }
...
goog.ui.registry.setDecoratorByClassName(
  ...
  () => new goog.ui.SelectionMenuButton()
);
