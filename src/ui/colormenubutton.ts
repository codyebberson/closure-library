 ...
 */
goog.ui.ColorMenuButton.newColorMenu = (opt_extraItems, opt_domHelper) => {
  var menu = new goog.ui.Menu(opt_domHelper);

  if (opt_extraItems) {
    opt_extraItems.forEach((item) => {
      menu.addChild(item, true);
    });
  }

  goog.object.forEach(goog.ui.ColorMenuButton.PALETTES, (colors) => {
...
goog.ui.registry.setDecoratorByClassName(
  ...
  () => new goog.ui.ColorMenuButton(null)
);
