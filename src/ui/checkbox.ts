...
goog.ui.Checkbox = function (opt_checked, opt_domHelper, opt_renderer) {
   ...
   * @private
   */
  this.checked_ = opt_checked !== undefined ? opt_checked : goog.ui.Checkbox.State.UNCHECKED;
};
...
goog.ui.Checkbox.prototype.toggle = function () {
  this.setChecked(
    this.checked_ ? goog.ui.Checkbox.State.UNCHECKED : goog.ui.Checkbox.State.CHECKED
  );
};
...
goog.ui.Checkbox.prototype.enterDocument = function () {
  ...
  if (this.isHandleMouseEvents()) {
    ...
    if (this.label_) {
      ...
      // itself.
      handler
        .listen(this.label_, goog.events.EventType.CLICK, this.handleClickOrSpace_)
        .listen(this.label_, goog.events.EventType.MOUSEOVER, this.handleMouseOver)
        .listen(this.label_, goog.events.EventType.MOUSEOUT, this.handleMouseOut)
        .listen(this.label_, goog.events.EventType.MOUSEDOWN, this.handleMouseDown)
        .listen(this.label_, goog.events.EventType.MOUSEUP, this.handleMouseUp);
    }
