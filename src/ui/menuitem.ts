    ...
    var caption = goog.array
      .map(content, (node) => {
        if (
          ...
          (goog.dom.classlist.contains(/** @type {!Element} */ (node), acceleratorClass) ||
            goog.dom.classlist.contains(/** @type {!Element} */ (node), mnemonicWrapClass))
        ) {
          return '';
        } else {
...
goog.ui.MenuItem.prototype.getAccelerator = function () {
  ...
  var content = this.getContent();
  if (Array.isArray(content)) {
    var acceleratorEl = goog.array.find(content, (e) =>
      goog.dom.classlist.contains(/** @type {!Element} */ (e), goog.ui.MenuItem.ACCELERATOR_CLASS)
    );
    if (acceleratorEl) {
...
goog.ui.MenuItem.prototype.getParent = function () {
  return /** @type {goog.ui.Menu} */ (goog.ui.Control.prototype.getParent.call(this));
};
...
goog.ui.MenuItem.prototype.getParentEventTarget = function () {
  return /** @type {goog.ui.Menu} */ (goog.ui.Control.prototype.getParentEventTarget.call(this));
};
