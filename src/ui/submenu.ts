...
goog.ui.SubMenu.prototype.setHighlighted = function (highlight, opt_btnPressed) {
  ...
  if (!highlight) {
    ...
    this.dismissTimer_ = goog.Timer.callOnce(this.dismissSubMenu, this.getMenuDelay(), this);
  }
};
...
goog.ui.SubMenu.prototype.handleKeyEvent = function (e) {
  ...
  var arrowOpenKeyCode = this.isRightToLeft()
    ? goog.events.KeyCodes.LEFT
    : goog.events.KeyCodes.RIGHT;
  var closeKeyCode = this.isRightToLeft() ? goog.events.KeyCodes.RIGHT : goog.events.KeyCodes.LEFT;
...
goog.ui.SubMenu.prototype.handleMouseOver = function (e) {
  if (this.isEnabled()) {
    this.clearTimers();
    this.showTimer_ = goog.Timer.callOnce(this.showSubMenu, this.getMenuDelay(), this);
  }
 ...
 * @protected
 */
goog.ui.SubMenu.prototype.getMenuDelay = () => goog.ui.SubMenu.MENU_DELAY_MS;
...
goog.ui.SubMenu.prototype.setSubMenuVisible_ = function (visible) {
  ...
  this.dispatchEvent(
    goog.ui.Component.getStateTransitionEvent(goog.ui.Component.State.OPENED, visible)
  );
  var subMenu = this.getMenu();
  if (visible != this.menuIsVisible_) {
    goog.dom.classlist.enable(
      goog.asserts.assert(this.getElement()),
      goog.getCssName('goog-submenu-open'),
      visible
    );
  }
...
goog.ui.SubMenu.prototype.setMenuListenersEnabled_ = function (menu, attach) {
  ...
  method.call(handler, menu, goog.ui.Component.EventType.ENTER, this.onChildEnter_);
};
...
goog.ui.SubMenu.prototype.positionSubMenu = function () {
  var position = new goog.positioning.AnchoredViewportPosition(
    this.getElement(),
    this.isAlignedToEnd() ? goog.positioning.Corner.TOP_END : goog.positioning.Corner.TOP_START,
  ...
  position.reposition(
    el,
    this.isAlignedToEnd() ? goog.positioning.Corner.TOP_START : goog.positioning.Corner.TOP_END
  );
...
goog.ui.SubMenu.prototype.getMenu = function () {
  if (!this.subMenu_) {
    this.setMenu(new goog.ui.Menu(this.getDomHelper()), /* opt_internal */ true);
