...
testSuite({
  ...
  testParsingUrl() {
    // a simple link
    assertExtractsCorrectly('uddeBVmKTqE', 'http://www.youtube.com/watch?v=uddeBVmKTqE');
    // a simple mobile link
    assertExtractsCorrectly('uddeBVmKTqE', 'http://m.youtube.com/watch?v=uddeBVmKTqE');
    // a secure mobile link
    assertExtractsCorrectly('uddeBVmKTqE', 'https://m.youtube.com/watch?v=uddeBVmKTqE');
    // a simple youtube-nocookie link
    assertExtractsCorrectly('uddeBVmKTqE', 'http://www.youtube-nocookie.com/watch?v=uddeBVmKTqE');
    // a simple /embed/ link
    assertExtractsCorrectly('uddeBVmKTqE', 'http://www.youtube.com/embed/uddeBVmKTqE?controls=0');
    ...
    assertExtractsCorrectly('uddeBVmKTqE', 'https://youtu.be/uddeBVmKTqE?feature=channel');
    // a channel link
    assertExtractsCorrectly(
      '4Pb9e1uu3EQ',
    ...
    // with a timestamp
    assertExtractsCorrectly('siJZXtsdfsf', 'http://www.youtube.com/watch?v=siJZXtsdfsf#t=2m59s');
    ...
    assertExtractsCorrectly(
      'siJZXtabxyz',
      'http://www.youtube.com/watch?foo=bar&v=siJZXtabxyz&x=y#t=1m30s' + '&videos=bar'
    );
    // only hash params
    assertExtractsCorrectly(
      'MWBpQoPwT3U',
    ...
    assertExtractsCorrectly('Lc-8onV5Jk-', 'http://www.youtube.com/watch?v=Lc-8onV5Jk-');
    ...
    for (let i = 0, j = invalidUrls.length; i < j; ++i) {
      ...
      assertEquals('failed to parse video id from youtube url: ' + invalidUrls[i], e.message);
    }
  },
