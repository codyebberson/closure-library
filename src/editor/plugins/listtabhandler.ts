...
/** @override */
goog.editor.plugins.ListTabHandler.prototype.getTrogClassId = () => 'ListTabHandler';
...
goog.editor.plugins.ListTabHandler.prototype.handleTabKey = function (e) {
  ...
  if (
    goog.dom.getAncestorByTagNameAndClass(range.getContainerElement(), goog.dom.TagName.LI) ||
    goog.iter.some(range, (node) => node.tagName == goog.dom.TagName.LI)
  ) {
