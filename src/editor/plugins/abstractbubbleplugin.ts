 ...
 * @private
 */
goog.editor.plugins.AbstractBubblePlugin.defaultBubbleFactory_ = (parent, zIndex) =>
  new goog.ui.editor.Bubble(parent, zIndex);
 ...
 * @private
 */
goog.editor.plugins.AbstractBubblePlugin.prototype.keyboardNavigationEnabled_ = false;
 ...
 */
goog.editor.plugins.AbstractBubblePlugin.prototype.setBubbleFactory = function (bubbleFactory) {
 ...
 */
goog.editor.plugins.AbstractBubblePlugin.prototype.enableKeyboardNavigation = function (
 ...
 * @protected
 */
goog.editor.plugins.AbstractBubblePlugin.prototype.getBubbleMap = () =>
  goog.editor.plugins.AbstractBubblePlugin.bubbleMap_;
 ...
 * @override
 */
goog.editor.plugins.AbstractBubblePlugin.prototype.handleSelectionChange = function (
  opt_e,
  opt_target
) {
  var selectedElement;
  if (opt_e) {
    ...
    if (range) {
      ...
      if (
        startNode.nodeType == goog.dom.NodeType.ELEMENT &&
        startNode == endNode &&
 ...
 * @suppress {strictMissingProperties} Added to tighten compiler checks
 */
goog.editor.plugins.AbstractBubblePlugin.prototype.handleSelectionChangeInternal = function (
  selectedElement
) {
  if (selectedElement) {
 ...
 */
goog.editor.plugins.AbstractBubblePlugin.prototype.getBubbleTargetFromSelection =
  goog.abstractMethod;
...
goog.editor.plugins.AbstractBubblePlugin.prototype.getSharedBubble_ = function () {
  ...
  if (!bubble) {
    var factory =
      this.bubbleFactory_ || goog.editor.plugins.AbstractBubblePlugin.globalBubbleFactory_;
    bubble = factory.call(null, bubbleParent, this.getFieldObject().getBaseZindex());
 ...
 * @protected
 */
goog.editor.plugins.AbstractBubblePlugin.prototype.getBubbleType = () => '';
 ...
 * @protected
 */
goog.editor.plugins.AbstractBubblePlugin.prototype.getBubbleTitle = () => '';
 ...
 * @protected
 */
goog.editor.plugins.AbstractBubblePlugin.prototype.shouldPreferBubbleAboveElement =
 ...
 */
goog.editor.plugins.AbstractBubblePlugin.prototype.registerClickHandler = function (
  target,
  handler
) {
 ...
 * @protected
 */
goog.editor.plugins.AbstractBubblePlugin.prototype.registerActionHandler = function (
  target,
  handler
) {
  this.eventRegister.listenWithWrapper(target, goog.events.actionEventWrapper, handler);
};
 ...
 * @protected
 */
goog.editor.plugins.AbstractBubblePlugin.prototype.onShow = () => {};
...
goog.editor.plugins.AbstractBubblePlugin.prototype.handleKeyDown = function (e) {
  if (
    this.keyboardNavigationEnabled_ &&
    this.isVisible() &&
 ...
 * @protected
 */
goog.editor.plugins.AbstractBubblePlugin.prototype.setTabbable = (element) => {
  if (!element.hasAttribute('tabindex')) {
    element.setAttribute('tabindex', 0);
  }
  goog.dom.classlist.add(element, goog.editor.plugins.AbstractBubblePlugin.TABBABLE_CLASSNAME_);
};
