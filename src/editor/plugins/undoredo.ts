 ...
 * @private
 */
goog.editor.plugins.UndoRedo.SUPPORTED_COMMANDS_ = goog.object.transpose(
  goog.editor.plugins.UndoRedo.COMMAND
);
 ...
 * @override
 */
goog.editor.plugins.UndoRedo.prototype.isSupportedCommand = (command) =>
  command in goog.editor.plugins.UndoRedo.SUPPORTED_COMMANDS_;
...
/** @override */
goog.editor.plugins.UndoRedo.prototype.getTrogClassId = () => 'UndoRedo';
...
goog.editor.plugins.UndoRedo.prototype.handleKeyboardShortcut = function (
  ...
  if (isModifierPressed) {
    ...
    if (command) {
      ...
      var state =
        command == goog.editor.plugins.UndoRedo.COMMAND.UNDO
 ...
 * @private
 */
goog.editor.plugins.UndoRedo.prototype.handleBlur_ = (e) => {
  var fieldObj = /** @type {goog.editor.Field} */ (e.target);
  if (fieldObj) {
 ...
 * @private
 */
goog.editor.plugins.UndoRedo.prototype.getCursorPosition_ = (fieldObj) => {
...
goog.editor.plugins.UndoRedo.prototype.updateCurrentState_ = function (fieldObj) {
  ...
  if (currentState) {
    ...
    if (currentState.undoContent_ == content) {
      ...
      if (
        (content == emptyContents && currentState.undoContent_ == '') ||
  ...
  this.currentStates_[fieldHashCode] = new goog.editor.plugins.UndoRedo.UndoState_(
    fieldHashCode,
    content,
    cursorPos,
    this.boundRestoreState_
  );
};
...
goog.editor.plugins.UndoRedo.UndoState_.prototype.equals = function (rhs) {
  return (
    this.fieldHashCode == rhs.fieldHashCode &&
