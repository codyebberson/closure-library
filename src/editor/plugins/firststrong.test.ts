...
testSuite({
  setUp() {
    ...
    field.execCommand = (command) => {
      if (command == Command.DIR_LTR || command == Command.DIR_RTL) triggeredCommand = command;
    };
  },
  ...
  testFirstCharacter_RTL() {
    field.setSafeHtml(false, testing.newSafeHtmlForTest('<div id="text">&nbsp;</div>'));
  ...
  testFirstCharacter_LTR() {
    field.setSafeHtml(false, testing.newSafeHtmlForTest('<div dir="rtl" id="text">&nbsp;</div>'));
    field.focusAndPlaceCursorAtStart();
  ...
  testFirstStrongCharacter_RTL() {
    field.setSafeHtml(
      false,
      testing.newSafeHtmlForTest('<div id="text">123.7 3121, <b><++{}></b> - $45</div>')
    );
    field.focusAndPlaceCursorAtStart();
    events.fireNonAsciiKeySequence(fieldElement, KeyCodes.T, ALEPH_KEYCODE);
    assertRTL();
  ...
  testFirstStrongCharacter_LTR() {
    field.setSafeHtml(
      false,
      testing.newSafeHtmlForTest('<div dir="rtl" id="text">123.7 3121, <b><++{}></b> - $45</div>')
    );
    field.focusAndPlaceCursorAtStart();
    events.fireKeySequence(fieldElement, KeyCodes.A);
    assertLTR();
  ...
  testNotStrongCharacter_RTL() {
    field.setSafeHtml(false, testing.newSafeHtmlForTest('<div id="text">123.7 3121, - $45</div>'));
    field.focusAndPlaceCursorAtStart();
  ...
  testNotStrongCharacter_LTR() {
    field.setSafeHtml(
      false,
      testing.newSafeHtmlForTest('<div dir="rtl" id="text">123.7 3121 $45</div>')
    );
    field.focusAndPlaceCursorAtStart();
    events.fireKeySequence(fieldElement, KeyCodes.NINE);
    assertNoCommand();
  ...
  testNotFirstStrongCharacter_RTL() {
    field.setSafeHtml(
      false,
      testing.newSafeHtmlForTest('<div id="text">123.7 3121, <b>English</b> - $45</div>')
    );
    field.focusAndPlaceCursorAtStart();
    events.fireNonAsciiKeySequence(fieldElement, KeyCodes.T, ALEPH_KEYCODE);
    assertNoCommand();
  ...
  testNotFirstStrongCharacter_LTR() {
    field.setSafeHtml(
      false,
      testing.newSafeHtmlForTest('<div dir="rtl" id="text">123.7 3121, <b>עברית</b> - $45</div>')
    );
    field.focusAndPlaceCursorAtStart();
    events.fireKeySequence(fieldElement, KeyCodes.A);
    assertNoCommand();
  ...
  testFirstStrongCharacterInNewLine_RTL() {
    field.setSafeHtml(false, testing.newSafeHtmlForTest('<div><b id="cur">English<br>1</b></div>'));
  ...
  testFirstStrongCharacterWithPreviousBlockSibling_RTL() {
    field.setSafeHtml(
      false,
      testing.newSafeHtmlForTest('<div>Te<div>xt</div>1<b id="cur">2</b>3</div>')
    );
  ...
  testFirstStrongCharacterWithPreviousBlockSibling_LTR() {
    field.setSafeHtml(
      false,
      testing.newSafeHtmlForTest('<div dir="rtl">טק<div>סט</div>1<b id="cur">2</b>3</div>')
    );
    range.placeCursorNextTo(dom.$('cur'), true);
    events.fireKeySequence(fieldElement, KeyCodes.A);
    assertLTR();
  ...
  testFirstStrongCharacterWithFollowingBlockSibling_RTL1() {
    field.setSafeHtml(
      false,
      testing.newSafeHtmlForTest('<div>1<b id="cur">2</b>3<div>Te</div>xt</div>')
    );
    range.placeCursorNextTo(dom.$('cur'), true);
    events.fireNonAsciiKeySequence(fieldElement, KeyCodes.T, ALEPH_KEYCODE);
    assertRTL();
  ...
  testFirstStrongCharacterWithFollowingBlockSibling_RTL2() {
    field.setSafeHtml(
      false,
      testing.newSafeHtmlForTest('<div dir="rtl">1<b id="cur">2</b>3<div>א</div>ב</div>')
    );
    range.placeCursorNextTo(dom.$('cur'), true);
    events.fireKeySequence(fieldElement, KeyCodes.A);
    assertLTR();
  ...
  testFirstStrongCharacterFromIME_RTL() {
    field.setSafeHtml(false, testing.newSafeHtmlForTest('<div id="text">123.7 3121, </div>'));
    field.focusAndPlaceCursorAtStart();
    const attributes = {};
  ...
  testFirstCharacterFromIME_LTR() {
    field.setSafeHtml(false, testing.newSafeHtmlForTest('<div dir="rtl" id="text"> 1234 </div>'));
    field.focusAndPlaceCursorAtStart();
    const attributes = {};
