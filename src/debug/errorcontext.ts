 ...
 */
goog.debug.errorcontext.addErrorContext = (err, contextKey, contextValue) => {
 ...
 */
goog.debug.errorcontext.getErrorContext = (err) => err[goog.debug.errorcontext.CONTEXT_KEY_] || {};
